exports.lalolib = (function () {
  ...
  function plot(multiargs) {
    ...
    for (p = 0; p < plotinfo.data.length; p++) {
      ...
      } else color = color = colors.splice(0, 1)[0];
    ...
    if (window.addEventListener)
      document
        ...
        .addEventListener("DOMMouseScroll", this.mousezoom, false);
  ...
  function colorplot(multiargs) {
    ...
    document.getElementById("legendmaxZ" + LALOLibPlotsIndex).innerHTML =
      plotinfo.maxZ.toPrecision(3);
    document.getElementById("legendminZ" + LALOLibPlotsIndex).innerHTML =
      plotinfo.minZ.toPrecision(3);
    if (window.addEventListener)
      document
        .getElementById(plotid)
        .addEventListener("DOMMouseScroll", this.mousezoom, false);
    ...
    if (canvas.getContext) {
      ...
      for (i = 0; i < imagedata.data.length; i++) {
        ...
        ctx.fillStyle =
          ...
          ")";
        ctx.fillRect(x, y, pixWidth + 1, pixHeight + 1);
      }
    }
  ...
  function mouseposition(e, plotidx) {
    ...
    if (LALOLABPLOTMOVING) {
      ...
      var x =
        xmouse / LALOLibPlots[plotidx].scaleX + LALOLibPlots[plotidx].minX;
      var y =
  ...
  function mousestartmove(e, plotidx) {
    if (e.button == 0) {
      ...
      var plotcanvas = document.getElementById(LALOLibPlots[plotidx].canvasId);
      var rect = plotcanvas.getBoundingClientRect();
      LALOLABPLOTxprev = e.clientX - rect.left;
  ...
  function parseAssignment(assignmentStr) {
    if (assignmentStr.indexOf("[") < 0) {
      ...
      if (middle >= 0) {
        ...
        var colsrange = assign.substr(middle + 2, end - (middle + 2));
  ...
  function parseBrackets(cmdString) {
    ...
    cmdString = cmdString.split("][").join(",");
    var cmd = cmdString.split("");
    var i;
    var j;
    var k;
    var l;
  ...
  function parseCommand(cmdString) {
    ...
    var cmd = parseBrackets(computeStr).split("");
    var startdelimiters = ["(", "[", ",", ";"];
    var enddelimiters = [")", "]", ",", ";"];
    var i;
    var j;
  ...
  function parseRangeRange(cmd) {
    ...
    for (i = 0; i < elems.length - 1; i++) {
      ...
      incargs = args[1].substr(0, args[1].length - 1);
      args[1] = endargs;
  ...
  function Lalolab(id, mllab, path) {
    ...
    if (typeof mllab != "undefined" && mllab) {
      this.worker = new Worker(path + "mlworker.js");
      this.labtype = "ml";
    } else {
      this.worker = new Worker(path + "lalolibworker.js");
      this.labtype = "lalo";
    }
  ...
  Lalolab.prototype.onresult = function (WorkerEvent) {
    if (typeof WorkerEvent.data.progress != "undefined") {
      ...
      var cb = this.parent.callbacks.splice(0, 1)[0];
      if (typeof cb == "function") {
        var WorkerCommand = WorkerEvent.data.cmd;
        var WorkerResult = WorkerEvent.data.output;
        cb(WorkerResult, WorkerCommand, this.parent.id);
      }
    }
  };
  ...
  function get(A, rowsrange, colsrange) {
    ...
    if (typeA == "vector") {
      ...
      if (rowsrange.length == 1 && colsrange.length == 1)
        return A.val[rowsrange[0] * A.n + colsrange[0]];
      if (rowsrange.length == 0) return getCols(A, colsrange);
      if (colsrange.length == 0) return getRows(A, rowsrange);
      ...
      if (typecols == "number") colsrange = [colsrange];
      if (rowsrange.length == 1 && colsrange.length == 1)
        return A.get(rowsrange[0], colsrange[0]);
      ...
      else return getSubspVector(A, rowsrange);
    } else if (typeA == "ComplexVector") {
      if (typerows == "number") return A.get(rowsrange);
      ...
      if (rowsrange.length == 0) return A.getCols(colsrange);
      if (colsrange.length == 0) return A.getRows(rowsrange);
      ...
      case "matrix":
        switch (type(b)) {
          ...
          case "matrix":
            if (a.n != b.m) {
              error(
                "Error in mul(A,B): A.n = " + a.n + " != " + b.m + " = B.m."
              );
              return undefined;
            }
          ...
          case "ComplexMatrix":
            ...
            return transpose(
              mulComplexMatrixMatrix(transpose(b), transpose(a))
            );
            break;
          default:
            return undefined;
    ...
    switch (type(a)) {
      ...
      case "vector":
        switch (type(b)) {
          ...
          case "ComplexMatrix":
            error(
              "Error in entrywisemul(a,B): a is a vector and B is a matrix."
            );
            return undefined;
            break;
          default:
      ...
      case "matrix":
        switch (type(b)) {
          ...
          case "ComplexVector":
            error(
              "Error in entrywisemul(A,b): A is a Matrix and b is a vector."
            );
            return undefined;
            break;
          case "matrix":
    ...
    switch (ta) {
      ...
      case "vector":
        switch (tb) {
          ...
          case "spvector":
            error(
              "Error in entrywisediv(a,b): b is a sparse vector with zeros."
            );
            break;
          default:
            error(
      ...
      case "matrix":
        switch (tb) {
          ...
          case "spmatrix":
            error(
              "Error in entrywisediv(A,B): B is a sparse matrix with zeros."
            );
            return undefined;
            break;
          default:
  ...
  function add(a, b) {
    ...
    if ((ta == "number" && tb == "number") || ta == "string" || tb == "string")
      ...
      switch (tb) {
        ...
        default:
          error(
            "Error in add(a,B): a is a sparse vector and B is a " + tb + "."
          );
          return undefined;
          break;
      }
      ...
      switch (tb) {
        ...
        default:
          error(
            "Error in add(A,b): a is a sparse matrix and B is a " + tb + "."
          );
          return undefined;
          break;
      }
  ...
  function sub(a, b) {
    ...
    if (ta == "number" && tb == "number") return a - b;
      ...
      switch (tb) {
        ...
        default:
          error(
            "Error in sub(a,B): a is a sparse vector and B is a " + tb + "."
          );
          return undefined;
          break;
      }
      ...
      switch (tb) {
        ...
        default:
          error(
            "Error in sub(A,b): a is a sparse matrix and B is a " + tb + "."
          );
          return undefined;
          break;
      }
  ...
  function solve(A, b) {
    ...
    } else return solveWithQRcolumnpivotingMultipleRHS(A, b);
  }
  ...
  function solveWithQRcolumnpivoting(A, b) {
    ...
    for (j = 0; j < r; j++) {
      ...
      set(
        btmp,
        range(j, m),
        sub(smallb, mul(beta[j] * mul(V[j], smallb), V[j]))
      );
    }
    var x = zeros(n);
    if (r > 1) {
  ...
  function solveGaussianElimination(Aorig, borig) {
    ...
    var j;
    var k;
    var A = matrixCopy(Aorig).toArrayOfFloat64Array();
  ...
  function ldlsymmetricpivoting(Aorig) {
    ...
    for (k = 0; k < n - 1; k++) {
      ...
      set(
        ...
        range(k + 1, n),
        sub(
          get(A, range(k + 1, n), range(k + 1, n)),
          outerprod(v, v, 1 / alpha)
        )
      );
    }
    for (var j = 0; j < n - 1; j++) {
        ...
        if (r > 1) {
          if (j == r - 1)
            ...
            set(
              ...
              sub(
                smallQ,
                outerprod(V[j], mul(transpose(smallQ), V[j]), beta[j])
              )
            );
        } else
          Q = subVectors(
  ...
  function qr(A, compute_Q) {
    ...
    var updateR = function (r, v, beta) {
      ...
      for (i = r; i < n; i++) {
        ...
        for (l = 0; l < m_r; l++) smallRiv += Rval[l] * v[l];
        smallRiv *= beta;
        for (j = 0; j < m_r; j++) {
          Rval[j] -= smallRiv * v[j];
        }
    ...
    while (tau > EPS && r < n - 1 && normR22 > TOLnormR22square) {
      ...
      c[r] = tau;
      if (r < m - 1) {
        householder = house(R.val.subarray(r * R.n + r, r * R.n + m));
      } else {
        householder.v = [1];
        householder.beta = 0;
      }
  ...
  function eig_inverseIteration(A, lambda) {
    ...
    k = 0;
    do {
      u = solveWithQRcolumnpivoting(QR, u);
      v = norm(u);
      u = entrywisediv(u, v);
      r = mulMatrixVector(A_lambdaI, u);
      k++;
    } while (k < maxIters && maxVector(absVector(r)) < 1e-10 * norminfA);
    return u;
  }
    ...
    do {
      ...
      if (q < n) {
        ...
        if (DiagonalofB22isZero >= 0) {
          ...
          if (computeUV) {
            var GKstep = GolubKahanSVDstep(B, p, p, n - q - p, n - q - p, true);
            for (var kk = 0; kk < n - q - p - 1; kk++) {
              if (computeU)
                premulGivens(
                  GKstep.csU[kk][0],
  ...
  function spVector(n, values, indexes) {
    ...
    if (arguments.length <= 2) {
      ...
      this.val = new Float64Array(nnz);
      this.ind = new Uint32Array(nnz);
    } else {
      var nnz = values.length;
      this.val = new Float64Array(values);
      this.ind = new Uint32Array(indexes);
    }
    this.nnz = nnz;
  }
  ...
  spVector.prototype.set = function (i, value) {
    ...
    if (k < 0) {
      ...
      ind[k] = i;
      val[k] = value;
      ind.set(this.ind.subarray(k), k + 1);
  ...
  function spMatrix(m, n, values, cols, rows) {
    ...
    if (arguments.length <= 3) {
      ...
      this.rowmajor = true;
      this.val = new Float64Array(nnz);
      this.cols = new Uint32Array(nnz);
      this.rows = new Uint32Array(m + 1);
    } else {
      var nnz = values.length;
      if (
        rows.length == nnz &&
        ...
        this.rowmajor = false;
        this.val = new Float64Array(values);
        this.cols = new Uint32Array(cols);
  ...
  function entrywisemulspMatrices(A, B) {
    if (A.rowmajor) {
      if (B.rowmajor) {
        ...
        return entrywisemulspMatrixMatrix(B, fullMatrix(A));
      }
    } else {
      if (B.rowmajor) {
        return entrywisemulspMatrixMatrix(A, fullMatrix(B));
      } else {
        var val = new Array();
  ...
  function minl0(A, b, M) {
    ...
    var lpsol = glp(cost, Aineq, bineq, Aeq, b, lb, ub, range(n, 2 * n));
  ...
  (function (exports) {
    ...
    var Ba = (exports.glp_create_prob = function () {
      ...
      Fa = (exports.glp_set_obj_dir = function (a, b) {
        ...
        null != c &&
          0 != c.reason &&
          w("glp_set_obj_dir: operation not allowed");
        b != za &&
          b != Ea &&
      ...
      Za = (exports.glp_set_mat_col = function (a, b, c, d, e) {
        ...
        null != f &&
          0 != f.reason &&
          w("glp_set_mat_col: operation not allowed");
        (1 <= b && b <= a.i) ||
    ...
    exports.glp_check_dup = function (a, b, c, d, e) {
      ...
      0 < c &&
        null == d &&
        w("glp_check_dup: ia = " + d + "; invalid parameter");
      0 < c &&
        null == e &&
        w("glp_check_dup: ja = " + e + "; invalid parameter");
      for (h = 1; h <= c; h++)
    ...
    var hb = (exports.glp_copy_prob = function (a, b, c) {
      ...
      db = (exports.glp_erase_prob = function (a) {
        ...
        null != b &&
          0 != b.reason &&
          w("glp_erase_prob: operation not allowed");
        a.Dd = 1061109567;
        a.ke = null;
        a.n = null;
        a.f = null;
    ...
    var ub = (exports.glp_get_mat_row = function (a, b, c, d) {
      ...
      zb = (exports.glp_set_rii = function (a, b, c) {
        ...
        0 >= c &&
          w(
            "glp_set_rii: i = " + b + "; rii = " + c + "; invalid scale factor"
          );
      ...
      Ab = (exports.glp_set_sjj = function (a, b, c) {
        ...
        0 >= c &&
          w(
            "glp_set_sjj: j = " + b + "; sjj = " + c + "; invalid scale factor"
          );
      ...
      Fb = (exports.glp_set_row_stat = function (a, b, c) {
        ...
        c != A &&
          ...
          c != Na &&
          w(
            "glp_set_row_stat: i = " + b + "; stat = " + c + "; invalid status"
          );
        b = a.n[b];
        if (c != A)
          switch (b.type) {
      ...
      Gb = (exports.glp_set_col_stat = function (a, b, c) {
        ...
        c != A &&
          ...
          c != Na &&
          w(
            "glp_set_col_stat: j = " + b + "; stat = " + c + "; invalid status"
          );
        b = a.f[b];
        if (c != A)
          switch (b.type) {
      ...
      sc = (exports.glp_simplex = function (a, b) {
        ...
        null != a.V &&
          0 != a.V.reason &&
          w("glp_simplex: operation not allowed");
        null == b && (b = new kc());
        b.o != lc &&
          b.o != Lb &&
          b.o != fc &&
    ...
    var fb = (exports.glp_set_bfcp = function (a, b) {
      ...
      xd = (exports.glp_ftran = function (a, b) {
        ...
        for (f = 1; f <= c; f++)
          (g = a.head[f]),
            (b[f] = g <= c ? b[f] / d[g].ma : b[f] * e[g - c].va);
      }),
    ...
    exports.glp_mpl_postsolve = function (a, b, c) {
      ...
      for (d = 1; d <= e; d++)
        c == Zb
          ...
          : c == le
          ? ((g = 0),
            (h = glp_ipt_row_prim(b, d)),
            (k = glp_ipt_row_dual(b, d)))
      ...
      for (d = 1; d <= f; d++)
        c == Zb
          ...
          : c == le
          ? ((g = 0),
            (h = glp_ipt_col_prim(b, d)),
            (k = glp_ipt_col_dual(b, d)))
    ...
    var Xe = "!\"#$%&()/,.;?@_`'{}|~",
      Ye = (exports.glp_read_lp = function (a, b, c) {
          ...
          0 > b
            ...
            : "\n" != b &&
              (0 <= " \t\n\v\f\r".indexOf(b)
                ? (b = " ")
                : ta(b) &&
                  d(a, "invalid control character " + b.charCodeAt(0)));
          a.l = b;
        }
        function g(a) {
          a.h += a.l;
              ...
              if ("e" == a.l || "E" == a.l)
                for (
                  g(a),
                    ("+" != a.l && "-" != a.l) || g(a),
                    wa(a.l) ||
                      d(a, "numeric constant `" + a.h + "' incomplete");
                  wa(a.l);
                  ...
                  a.b == W || a.b == X
                    ? ((f = a.b == W ? 1 : -1),
                      ...
                      a.b == F
                        ...
                        : h(a.h, "infinity") || h(a.h, "inf")
                        ? (0 > f &&
                            d(a, "invalid use of `-inf' as upper bound"),
                          q(a, b, +s),
                          k(a))
        ...
        z.b != y &&
          z.b != E &&
          d(z, "`minimize' or `maximize' keyword missing");
        (function (a) {
          var b, c;
    ...
    function Oe(a, b, c, d, e, f) {
      ...
      for (u = 1; u <= g; u++)
        (e = ka[u]),
          0 == e || Math.abs(e) < V || (c++, (ca[c] = u), (ka[c] = e));
      X = q[b];
      for (W = X + r[b] - 1; X <= W; X++) {
        u = D[X];
        f = k[u];
    ...
    function qf(a) {
      ...
      if (null == e.R)
        ...
        for (k = 1; k <= d; k++)
          Wa(b, k, a.se[c + k], a.qe[c + k], a.te[c + k]),
            Gb(b, k, a.re[c + k]);
      }
      a.N = null;
    }
      ...
      if (0 == e) {
        ...
        for (e = 1; e <= g; e++) {
          if (1 == e) d = h[1];
            ...
            for (f = h[e], l = void 0; 0 < f; ) (l = d % f), (d = f), (f = l);
          if (1 == d) break;
        }
        e = d;
      }
          ...
          if (((k = b.f[c]), k.kind == Fc))
            switch (((g = k.c), (h = k.d), (d = k.m), (k = k.J), b.dir)) {
              case za:
                d == G
                  ? (0 > k && (k = 0),
                    f + k >= b.ta && (Wa(b, c, B, g, g), e++))
                  : d == Ua &&
                    (0 < k && (k = 0),
                    f - k >= b.ta && (Wa(b, c, B, h, h), e++));
                break;
              case Ea:
                d == G
                  ? (0 < k && (k = 0),
      ...
      for (q = 0; ; ) {
        ...
        switch (q) {
          case 0:
            ...
            0 == a.gf &&
              (a.gf = 1 == a.Pd ? a.head.s : 0 != a.ud ? a.ud : Rf(a));
            pf(a, a.gf);
            a.gf = a.ud = 0;
              ...
              (a.lb[d] == lg
                ? ((e = a.Yb[d]),
                  0 == e
                    ...
                    : ((c = a.G.Ja[e]),
                      0 == c &&
                        (eg(a.G, e, 1), (c = a.G.Ja[e]), (a.G.j[c] = 0)),
    ...
    function Tf(a) {
      ...
      x(
        "The conflict graph has 2*" + l.Cb + " vertices and " + l.Dg + " edges"
      );
      return l;
    }
    function ng(a, b, c) {
      ...
      for (u = 1; u <= d; u++) {
        ...
        for (S = 1; S <= z; S++)
          (P = ba[S]),
            ...
            (1 <= P && P <= d) ||
              w(
                "luf_factorize: i = " + P + "; j = " + u + "; invalid row index"
              ),
            X[P] &&
              w(
                "luf_factorize: i = " +
    ...
    function Y(a) {
      ...
      function d() {
        if ("e" == a.l || "E" == a.l)
          for (
            pk(a),
              ("+" != a.l && "-" != a.l) || pk(a),
              wa(a.l) ||
                (mk(a), U(a, "numeric literal " + a.h + " incomplete"));
            wa(a.l);
        ...
        if (ua(a.l) || "_" == a.l)
          mk(a),
            U(a, "symbol " + a.h + a.l + "... should be enclosed in quotes");
      }
      a.Hf = a.b;
      a.Gf = a.Bb;
      a.Ff = a.h;
    ...
    function Qk(a) {
      ...
      if (a.b == Dh)
        ...
        if (a.b != Kh)
          c.type == fh && U(a, "keyword else missing where expected"),
            (d = null);
        else {
          Y(a);
          d = Gk(a);
      ...
      for (g.link = f; ; ) {
        ...
        if (rk(a, "dimen")) {
          ...
          g < k.set.X &&
            U(
              a,
              "there are must be " + k.set.X + " components rather than " + g
            );
          Y(a);
    ...
    function cl(a) {
      ...
      a.b != Ah &&
        ok(a, "some text detected beyond end statement; text ignored");
    }
    function el(a, b) {
      var c = { v: {} };
      c.bb = a.bb;
      ...
      if (rk(a, "set"))
        ...
        switch (e.type) {
          case lh:
            ...
            f = 0;
            for (
              a.b == si ? Y(a) : U(a, "field list missing where expected");
              ;
            ...
            if (dl(a, "-")) {
              ...
              (g = hl(f)),
                1 == g
                  ? U(
                      a,
                      "one item missing in data group beginning with " + rl(k)
                    )
                  : U(
                      a,
    ...
    function Ql(a, b, c) {
      Math.abs(c) < aa &&
        U(a, b + " div " + c + "; floating-point zero divide");
      1 > Math.abs(c) &&
        Math.abs(b) > 0.999 * s * Math.abs(c) &&
    ...
    function Tl(a, b) {
      b > 0.999 * Math.log(s) &&
        U(a, "exp(" + b + "); floating-point overflow");
      return Math.exp(b);
    }
    function Ul(a, b) {
    ...
    function ul(a, b, c) {
      null != yl(a, b, c) &&
        U(a, "duplicate tuple " + zl("(", c) + " detected");
      jm(b, c);
    }
    function km(a, b) {
      var c, d;
    ...
    function xm(a, b) {
      ...
      switch (b.Ta) {
        ...
        case Cj:
          ...
          c = xm(a, b.a.a.y);
          c = nl(
            (null == d.M ? String(d.Q) : d.M) +
              (null == c.M ? String(c.Q) : c.M)
          );
          break;
        case Zj:
          c = ym(a, b.a.a.x)
    ...
    function jn(a, b) {
      switch (b.code.Ta) {
        case dk:
          ...
          for (
            null == b.value ? (b.value = c) : (b.Xa.e = c);
            null != c;
            c = c.e
          )
            b.Xa = c;
              ...
              switch (c.code.type) {
                ...
                case T:
                  ...
                  null != h.M &&
                    U(
                      a,
                      "cannot convert " + rl(h) + " to floating-point number"
                    );
                  g = h.Q;
                  break;
                case nh:
      ...
      for (t = n = 0; t < c.length; t++)
        if ("%" == c[t])
          if ((t++, "b" == c[t] || "h" == c[t])) {
            ...
            "%" == c[t]
              ? f()
              : On(a, b, n, c, t, "invalid conversion specifier");
        else " " != c[t] && f();
      0 > h && (h = 1970);
      0 > k && (k = 1);
      0 > l && (l = 1);
    ...
    function Vn(a) {
      if (-1 == a.l) (a.Hb = a.ng), (a.pb = "EOF");
        ...
        if (
          ...
          "\n" == a.l &&
            w(a.Ea + ":" + a.count + ": empty record not allowed\n"),
          "#" == a.l && 1 == a.count)
        )
          for (; "#" == a.l; ) {
            for (; "\n" != a.l; ) Wn(a);
        ...
        0 == a.pb.length &&
          w(a.Ea + ":" + a.count + ": empty field not allowed");
      } else {
        a.pb = "";
        for (a.Hb = a.og; "," != a.l && "\n" != a.l; )
          ("'" != a.l && '"' != a.l) ||
    ...
    Un.prototype.readRecord = function (a) {
      ...
      for (b = 1; b <= this.Wa; b++) {
        ...
        if (this.Hb == this.Ae) {
          ...
          this.Hb == this.Be && 0 < this.Oa[b] && sn(a, this.Oa[b], this.pb);
      }
      Vn(this);
    ...
    function Ub(a, b) {
      ...
      if (a.da == Zb) {
        ...
        for (c = 1; c <= a.i; c++)
          (d = b.f[c]), (e = a.Sd[c]), (a.Pa[e] = d.dc);
      } else if (a.da == Sc)
        for (c = 1; c <= a.i; c++)
          (d = b.f[c]), (e = a.Sd[c]), (a.Pa[e] = d.Sa);
    ...
    function Ko(a, b, c) {
      ...
      else if (16 != (k & 240) && 32 == (k & 240) && 0 == zo(a, b, 1))
        return d();
      if (b.c == -s && b.d == +s) {
    ...
    function No(a) {
      ...
      b = 1;
      for (c = 32; 55 >= c; b++, c++)
        a.nb[b] = (a.nb[b] - a.nb[c]) & 2147483647;
    ...
    function Pb(a, b) {
      ...
      function y(a, b) {
        ...
        for (g = 0; g < c; )
          (f = d[c]),
            Math.abs(e[f]) < h ? c-- : (g++, (d[c] = d[g]), (d[g] = f));
        a.sh = g;
      }
      function E(a, b) {
        var c = a.g,
        ...
        for (m = 1; m <= c; m++)
          if (((n = h[m]), 1 == k && 0 > g[n])) {
            ...
            if (d[n] == Sa || d[n] == I || d[n] == B)
              if (((p = b * (1 + L * Math.abs(e[n]))), l[m] < e[n] - p))
                return 1;
            if (d[n] == Ta || d[n] == I || d[n] == B)
              if (((p = b * (1 + L * Math.abs(f[n]))), l[m] > f[n] + p))
                return 1;
          }
        return 0;
      }
      ...
      for (b.o >= mc && x("Objective scale factor = " + v.$a + ""); ; ) {
        ...
        if (0 == v.s) {
          ...
          switch (v.D) {
            case 1:
              b.o >= Lb &&
                x("Error: unable to choose basic variable on phase I");
              a.U = v.U;
              v.U = null;
              a.na = a.sa = Aa;
              a.aa = 0;
    ...
    for (var l = 0; l < s; l++) {
      ...
      for (var j = 0; j < l1; j++) {
        for (var i = j; i < n; i += l2) {
          var i1 = i + l1;
          var t1re = u.re * X.re[i1] - u.im * X.im[i1];
  ...
  function ifft(x) {
    ...
    if (s % 1 != 0) {
      error(
        "ifft(x) only implemented for x.length = 2^m. Use idft(x) instead."
      );
      return undefined;
    }
    var X = new ComplexVector(x, zeros(n));
  ...
  Diagram.prototype.rect = function (
    x,
    y,
    w,
    h,
  ...
  Plot.prototype.plot_path = function (
    x,
    y,
    color_idx,
    radius,
  ...
  Plot.prototype.mousestartmove = function (e) {
    ...
    if (e.button == 0) {
      this.MOVING = true;
      var rect = canvas.getBoundingClientRect();
      this.xprev = e.clientX - rect.left;
      ...
      for (
        ...
        for (
          ...
          if (Math.abs(Y[i][j]) < 0.00001) {
            ...
            ctx.fillStyle =
              "rgba(" +
              Math.floor((Y[i][j] - minf) * colorScale) +
              ",0,0, 0.9)";
          }
          ctx.fillRect(
            (x1 - this.minX1) * this.scaleX1 - 2,
  ...
  Plot2D.prototype.plot_vector = function (
    ...
    var theta1 = Math.atan((end_x2 - start_x2) / (end_x1 - start_x1));
    var theta2 = Math.atan((end_x1 - start_x1) / (end_x2 - start_x2));
    var arrowsize = 10;
  ...
  function Plot3D(canvasId) {
    ...
    if (window.addEventListener)
      canvas.addEventListener("DOMMouseScroll", this.mousezoom, false);
  ...
  Plot3D.prototype.drawsphere = function (center, radius, spherename, color) {
    ...
    if (distance >= 0) {
      ...
      var radius2D = Math.floor(
        radius * (0 + 3 * (1 - opacity) * (1 - opacity))
      );
